...
public class SharedPreferencesUtil {
    ...
    public static String getEncryptPassword() {return (String)get(App.getApp(), ENCRYPT_PASSWORD, "");}

    public static void saveEncryptPassword(String encryptPassword) {put(App.getApp(), ENCRYPT_PASSWORD, encryptPassword);}
